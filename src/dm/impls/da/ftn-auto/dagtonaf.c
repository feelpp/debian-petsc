...
extern "C" {
#endif
void PETSC_STDCALL  dmdaglobaltonaturalallcreate_(DM da,VecScatter *scatter, int *__ierr ){
*__ierr = DMDAGlobalToNaturalAllCreate(
	(DM)PetscToPointer((da) ),scatter);
}
void PETSC_STDCALL  dmdanaturalalltoglobalcreate_(DM da,VecScatter *scatter, int *__ierr ){
