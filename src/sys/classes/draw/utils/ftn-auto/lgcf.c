...
void PETSC_STDCALL  petscdrawlgcreate_(PetscDraw draw,PetscInt *dim,PetscDrawLG *outctx, int *__ierr ){
...
void PETSC_STDCALL  petscdrawlggetdimension_(PetscDrawLG lg,PetscInt *dim, int *__ierr ){
...
void PETSC_STDCALL  petscdrawlgview_(PetscDrawLG lg,PetscViewer viewer, int *__ierr ){
