...
void PETSC_STDCALL  petscviewerdrawgetpause_(PetscViewer viewer,PetscReal *pause, int *__ierr ){
*__ierr = PetscViewerDrawGetPause(
	(PetscViewer)PetscToPointer((viewer) ),pause);
}
void PETSC_STDCALL  petscviewerdrawsetpause_(PetscViewer viewer,PetscReal *pause, int *__ierr ){
*__ierr = PetscViewerDrawSetPause(
	(PetscViewer)PetscToPointer((viewer) ),*pause);
}
void PETSC_STDCALL  petscviewerdrawsethold_(PetscViewer viewer,PetscBool *hold, int *__ierr ){
*__ierr = PetscViewerDrawSetHold(
	(PetscViewer)PetscToPointer((viewer) ),*hold);
}
void PETSC_STDCALL  petscviewerdrawgethold_(PetscViewer viewer,PetscBool *hold, int *__ierr ){
