...
extern "C" {
#endif
void PETSC_STDCALL  petsccommbuildtwosidedsettype_(MPI_Fint * comm,PetscBuildTwoSidedType *twosided, int *__ierr ){
*__ierr = PetscCommBuildTwoSidedSetType(
	MPI_Comm_f2c( *(comm) ),*twosided);
}
void PETSC_STDCALL  petsccommbuildtwosidedgettype_(MPI_Fint * comm,PetscBuildTwoSidedType *twosided, int *__ierr ){
